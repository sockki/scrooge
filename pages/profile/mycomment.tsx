...
interface myCommentPosts extends Answer {
  post:PostWithUser;
}

interface myCommentRes {
  mycomments: myCommentPosts[];
}
                  ...
                  <div className="">
                    ...
                    <div className="mt-1 bg-white px-2 py-4 rounded-xl flex justify-center items-center flex-col">
                      <span className="text-gray-800 text-xl font-semibold">
                        {`${mycomment?.post?.money}원`}
                      </span>
                      <span className="text-gray-800 text-lg">
                        {mycomment?.post?.what}
                      </span>
                      <span className="text-gray-800 text-sm">
                        {mycomment?.post?.description}
                      </span>
                    </div>
                    <div className="flex justify-between mt-2 ml-1">
                      <div className="flex space-x-2">
                        <div className="flex">
                          ...
                          <span className="text-pink-600 text-sm ml-1">{`${mycomment?.post?._count?.GoVote}`}</span>
                        </div>
                        <div className="flex">
                          <div className="text-teal-600 px-1 text-sm font-bold rounded-lg border-[1.5px] border-teal-600">
                            Save!
                          </div>
                          <span className="text-teal-600 text-sm ml-1">{`${mycomment?.post?._count?.StopVote}`}</span>
                        </div>
                        <div className="flex space-x-1">
                          ...
                          <span className="text-slate-10 text-sm">{`${mycomment?.post?._count?.Answer}`}</span>
                        </div>
                      </div>
                      <div className="text-slate-10 text-[1px] mr-4 ">
                        {`${String(mycomment?.post?.createdAt).substring(0, 10)}  ${String(mycomment?.post?.createdAt).substring(11,16)}`}
                      </div>
                    </div>
                  </div>
                  <div></div>
                    ...
                    <div className="flex justify-between space-x-3 mt-1 ml-1">
                      <div className="flex space-x-2">
                        <div className="flex">
                          ...
                          <span className="text-[#f4f814] text-sm ml-1">{`${mycomment?.post?._count?.GoVote}`}</span>
                        </div>
                        <div className="flex">
                          <span className="mt-1 ml-1">
                            <svg
                          ...
                          <span className="text-slate-100  text-sm ml-1">{`${mycomment?.post?._count?.Answer}`}</span>
                        </div>
                      </div>
                      <div>
